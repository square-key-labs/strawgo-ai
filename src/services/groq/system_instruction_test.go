...
func captureFirstSystemMessage(t *testing.T, cfg GroqLLMConfig, ctxPrompt string) string {
	t.Helper()
...
func TestSystemInstructionWinsOverContextPrompt(t *testing.T) {
	got := captureFirstSystemMessage(t, GroqLLMConfig{SystemInstruction: "service-level"}, "context-level")
...
func TestSystemInstructionWithoutContextPrompt(t *testing.T) {
	got := captureFirstSystemMessage(t, GroqLLMConfig{SystemInstruction: "service-only"}, "")
	if got != "service-only" {
...
func TestContextPromptWithoutSystemInstruction(t *testing.T) {
	got := captureFirstSystemMessage(t, GroqLLMConfig{}, "context-only")
	if got != "context-only" {
...
func TestNoSystemPromptAtAll(t *testing.T) {
	got := captureFirstSystemMessage(t, GroqLLMConfig{}, "")
	if got != "" {
