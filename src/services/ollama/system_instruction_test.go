...
func captureFirstSystemMessage(t *testing.T, cfg OllamaLLMConfig, ctxPrompt string) string {
	t.Helper()
...
func TestSystemInstructionWinsOverContextPrompt(t *testing.T) {
	got := captureFirstSystemMessage(t, OllamaLLMConfig{SystemInstruction: "service-level"}, "context-level")
...
func TestSystemInstructionWithoutContextPrompt(t *testing.T) {
	got := captureFirstSystemMessage(t, OllamaLLMConfig{SystemInstruction: "service-only"}, "")
	if got != "service-only" {
...
func TestContextPromptWithoutSystemInstruction(t *testing.T) {
	got := captureFirstSystemMessage(t, OllamaLLMConfig{}, "context-only")
	if got != "context-only" {
...
func TestNoSystemPromptAtAll(t *testing.T) {
	got := captureFirstSystemMessage(t, OllamaLLMConfig{}, "")
	if got != "" {
